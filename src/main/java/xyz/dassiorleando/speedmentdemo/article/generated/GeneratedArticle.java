 ...
 * xyz.dassiorleando.speedmentdemo.article.Article}-interface representing
 * entities of the {@code article}-table in the database.
 * <p>
...
public interface GeneratedArticle {
     ...
     */
    ComparableField<Article, Timestamp, Timestamp> PUBLISHED_DATE = DatastoreFields.createComparableField(
     ...
     * @return              this Article instance
     */
    Article setPublishedDate(Timestamp publishedDate);
